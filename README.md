...
**Day job:** C#, Crestron SIMPL+/SIMPL#, Q-SYS Lua, Swift, Azure, enterprise AV control systems

**Building with:** Swift/SwiftUI, Node.js, Express, TypeScript, Python, Docker, SQLite, Astro, Tailwind CSS

**AI stack:** Claude (Opus/Sonnet), OpenClaw multi-agent orchestration, Gemini, local LLMs via Ollama

**Infrastructure:** macOS launchd services, Colima/Docker, Tailscale, Umbrel self-hosting, Gitea, GitHub Actions

**Certified:** Microsoft C# Developer, Crestron Certified Programmer, First Class Honours Degree
...
![GitHub Contribution Graph](https://ghchart.rshah.org/waynegeorge)
